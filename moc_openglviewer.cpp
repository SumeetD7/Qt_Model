...
QT_MOC_LITERAL(1, 12, 8), // "showMsg1"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 16), // "QTreeWidgetItem*"
QT_MOC_LITERAL(4, 39, 4), // "item"
QT_MOC_LITERAL(5, 44, 8) // "colindex"

    },
    "QtOSGWidget\0showMsg1\0\0QTreeWidgetItem*\0"
    "item\0colindex"
};
...
void QtOSGWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->showMsg1((*reinterpret_cast< QTreeWidgetItem*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
    }
}
...
const QMetaObject QtOSGWidget::staticMetaObject = {
    { &QOpenGLWidget::staticMetaObject, qt_meta_stringdata_QtOSGWidget.data,
      qt_meta_data_QtOSGWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtOSGWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtOSGWidget.stringdata0))
        return static_cast<void*>(const_cast< QtOSGWidget*>(this));
